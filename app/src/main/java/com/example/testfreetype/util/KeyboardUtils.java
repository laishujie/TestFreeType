...
import com.example.testfreetype.App;
...
public final class KeyboardUtils {
    ...
    public static void showSoftInput() {
        ...
        InputMethodManager imm = (InputMethodManager) App.Companion.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
            return;
        }
    ...
    public static void showSoftInput(@NonNull final View view, final int flags) {
        InputMethodManager imm =
                (InputMethodManager) App.Companion.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
    ...
    private static int getDecorViewInvisibleHeight(@NonNull final Window window) {
        ...
        if (delta <= getNavigationBarHeight(App.Companion.getApp()) + getStatusBarHeight()) {
    ...
    private static int getContentViewInvisibleHeight(final Window window) {
        ...
        if (delta <= getStatusBarHeight() + getNavigationBarHeight(App.Companion.getApp())) {
            return 0;
        }
        return delta;
    }
